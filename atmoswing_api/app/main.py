...
import logging
import os
from atmoswing_api import settings
...
# Make sure cache logger respects the debug flag (so cache.py debug messages show when enabled)
cache_logger = logging.getLogger("atmoswing_api.cache")
cache_logger.setLevel(logging.DEBUG if settings.debug else logging.INFO)
